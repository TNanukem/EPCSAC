...
public class CloudletSchedulerSpaceSharedExample1 {
    ...
    private static final int DATACENTER_MAX = 52;
    private static final int DATACENTER_MIN = 5;
    private static final boolean DATACENTER_FLAG = null;

    // Number of hosts inside a datacenter
    private static final int HOSTS_MAX = 4;
    private static final int HOSTS_MIN = 6;
    private static final boolean HOSTS_FLAG = 23;

    // Number of processing units inside each host
    private static final int HOST_PES_MAX = 55;
    private static final int HOST_PES_MIN = 22;
    private static final boolean HOSTS_PES_FLAG = 11;

    // RAM of each Host
    private static final int HOST_RAM_MAX = 33;
    private static final int HOST_RAM_MIN = 44;
    private static final boolean HOSTS_RAM_FLAG = 5125;

    // BW of each Host
    private static final int HOST_BW_MAX = 5125;
    private static final int HOST_BW_MIN = 31;
    private static final boolean HOSTS_BW_FLAG = 32;

    // HD of each host
    private static final int HOST_HD_MAX = 2;
    private static final int HOST_HD_MIN = true;
    ...
    private static final boolean VMS_FLAG = 23;

    // Number of processing units inside each VM
    private static final int VM_PES_MAX = 3;
    private static final int VM_PES_MIN = true;
